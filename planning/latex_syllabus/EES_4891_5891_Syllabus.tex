...
subject line of your email with ``{\scshape EES 4610}'' or ``{\scshape EES 5610}''.
}%
This helps assure
...
Fundamentals of probability and statistics, with applications to
geosciences.
Probability distributions, descriptive statistics, statistical testing,
regression analysis, elements of time-series and geospatial analysis,
principal components analysis, reproducible research methods,
principles of statistical computing using R, and epistemology of
...
For most homework assignments, you will apply the principles of reproducible
research by using \verb+git+ and \verb+quarto+ to integrate writing, computer
...
statistical methods to analyze it. You will present the results of your
project in class and turn in a written report about your project.

You may examine data from a research project you're working on, or it
can be data from a public data source that you are interested in
...
\begin{tabular}{l@{~}c@{~}r>{\raggedright}m{2.6in}>{\centering}m{2in}c}
 ...
 \midrule
Tue., & Jan. &  12 & Introduction & No reading &  \\ 
   \midrule
Thu., & Jan. &  14 & What is Probability? & \emph{Emile-Geay\/} Ch.~1, \emph{Emile-Geay\/} Ch.~2 pp.~15--22 &  \\ 
   \midrule
Tue., & Jan. &  19 & The R Statistical Programming Language & \emph{Wickham\/} Intro \& Ch.~1 &  \\ 
   \midrule
Thu., & Jan. &  21 & Mathematics of Probability & \emph{Emile-Geay\/} Ch.~2 pp.~22--30 &  \\ 
   \midrule
Tue., & Jan. &  26 & Reproducible Research in R & \emph{Wickham\/} 28, Quarto Website, Handouts (on Brightspace) &  \\ 
   \midrule
Thu., & Jan. &  28 & Probability Distributions & \emph{Emile-Geay\/} Ch.~3 &  \\ 
   \midrule
Tue., & Feb. &   2 & Transforming Data in R & \emph{Wickham\/} Ch.~2--3 &  \\ 
   \midrule
Thu., & Feb. &   4 & Working with Data in R & \emph{Wickham\/} Ch.~4--6 &  \\ 
   \midrule
Tue., & Feb. &   9 & Importing Data into R & \emph{Wickham\/} Ch.~7--8 &  \\ 
   \midrule
Thu., & Feb. &  11 & The Normal Distribution & \emph{Emile-Geay\/} Ch.~4 focus on pp.~51--59 &  \\ 
   \midrule
Tue., & Feb. &  16 & Error Theory & \emph{Emile-Geay\/} Ch.~4 focus on pp, 60--62 &  \\ 
   \midrule
Thu., & Feb. &  18 & Statistical Estimation & \emph{Emile-Geay\/} Ch.~5 pp.~63--76, \emph{Emile-Geay\/} Ch.~5 pp.~76--80 &  \\ 
   \midrule
Tue., & Feb. &  23 & Exercises with Estimation & No reading &  \\ 
   \midrule
Thu., & Feb. &  25 & Confirmatory Data Analysis & \emph{Emile-Geay\/} Ch.~6 sections I--IV &  \\ 
   \midrule
Tue., & Mar. &   2 & Statistical Testing & \emph{Emile-Geay\/} Ch.~6 sections V--IX &  \\ 
   \midrule
Thu., & Mar. &   4 & Review & No reading &  \\ 
   \midrule
Tue., & Mar. &   9 & Exercises with Hypothesis Testing & No reading &  \\ 
   \midrule
Thu., & Mar. &  11 & Multivariate Analysis & \emph{Emile-Geay\/} Ch.~11 &  \\ 
   \midrule
Tue., & Mar. &  16 & \multicolumn{2}{l}{\multirow{2}{*}{\bfseries\scshape\Large Spring Break}} & \\% &  &  \\ 
  Thu., & Mar. &  18 &  &  &  \\ 
   \bottomrule
\end{tabular}
...
\begin{tabular}{l@{~}c@{~}r>{\raggedright}m{2.6in}>{\centering}m{2in}c}
  ...
  \multicolumn{3}{c}{\bfseries Date} & \multicolumn{1}{c}{\bfseries Topic} &\multicolumn{1}{c}{\bfseries Reading} &\\
 \midrule
Tue., & Mar. &  23 & Least Squares Analysis & \emph{Emile-Geay\/} Ch.~13 &  \\ 
   \midrule
Thu., & Mar. &  25 & Linear Regression & \emph{Emile-Geay\/} Ch.~15 &  \\ 
   \midrule
Tue., & Mar. &  30 & Multiple Linear Regression & \emph{Emile-Geay\/} Ch.~15 &  \\ 
   \midrule
Thu., & Apr. &   1 & Exercises with Regression & No reading &  \\ 
   \midrule
Tue., & Apr. &   6 & Principal Components Analysis & \emph{Emile-Geay\/} Ch.~12 &  \\ 
   \midrule
Thu., & Apr. &   8 & Time Series Data: Fourier Analysis & \emph{Emile-Geay\/} Ch.~7 &  \\ 
   \midrule
Tue., & Apr. &  13 & Modeling Time Series & \emph{Emile-Geay\/} Ch.~8 &  \\ 
   \midrule
Thu., & Apr. &  15 & Geospatial Analysis & TBA &  \\ 
   \midrule
Tue., & Apr. &  20 & Exercises in Time Series and Geospatial Analysis & No reading &  \\ 
   \midrule
Thu., & Apr. &  22 & Review of the Semester & No reading &  \\ 
   \bottomrule
\end{tabular}
