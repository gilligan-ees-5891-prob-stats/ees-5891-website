...
will choose a data set that's interesting to you and apply statistical methods
to analyze it. You will present the results of your project to the class
and turn in a written report about your project.

You may examine data from a research project you're working on, or it can be
data from a public data source that you are interested in understanding better.
...
Thu., & Mar. &  20 & Least Squares Analysis & \emph{Emile-Geay\/} Ch.~13 &  \\
   \midrule
Tue., & Mar. &  25 & Linear Regression & \emph{Emile-Geay\/} Ch.~15 &  \\
   \midrule
Thu., & Mar. &  27 & Exercises with Regression & No reading &  \\
   \midrule
Tue., & Apr. &   1 & Principal Components Analysis & \emph{Emile-Geay\/} Ch.~11 &  \\
   \midrule
Thu., & Apr. &   3 & Time Series Data: Fourier Analysis & \emph{Emile-Geay\/} Ch.~7 &  \\
   \midrule
Tue., & Apr. &   8 & Modeling Time Series & \emph{Emile-Geay\/} Ch.~8 &  \\
   \midrule
Thu., & Apr. &  10 & Geospatial Analysis & TBA & \\
   \midrule
Tue., & Apr. &  15 & Exercises in Time Series and Geospatial Analysis & No reading &  \\
   \midrule
