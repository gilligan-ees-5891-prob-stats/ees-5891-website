...
Tue., & Mar. &  30 & Multiple Linear Regression & \emph{Emile-Geay\/} Ch.~15 &  \\ 
   \midrule
Thu., & Apr. &   1 & Regression with Discrete vs. Continuous Variables & \emph{Emile-Geay\/} Ch.~15 &  \\ 
   \midrule
Tue., & Apr. &   6 & Exercises with Regression & No reading &  \\ 
   \midrule
Thu., & Apr. &   8 & Principal Components Analysis & \emph{Emile-Geay\/} Ch.~12 &  \\ 
   \midrule
Tue., & Apr. &  13 & Time Series Data: Fourier Analysis & \emph{Emile-Geay\/} Ch.~7 &  \\ 
   \midrule
Thu., & Apr. &  15 & Modeling Time Series & \emph{Emile-Geay\/} Ch.~8 &  \\ 
   \midrule
Tue., & Apr. &  20 & Exercises in Time Series Analysis & No reading &  \\ 
   \midrule
