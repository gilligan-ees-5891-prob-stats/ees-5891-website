...
## Using the Insert Citation Tool

You can bring up the Insert Citation tool by clicking on the "Insert"
button on the toolbar, or pressing $\Uparrow \hat{} \text{F8}$
(`Ctrl-Shift-F8`) on your keyboard. This will bring up a dialog box
where you can look up references in your personal bibliography
(including Zotero), via a DOI (digital object identifier) code, or
from public bibliographic databases such as CrossRef or PubMed.
